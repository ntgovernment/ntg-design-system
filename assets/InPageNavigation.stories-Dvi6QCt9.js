import{j as e}from"./jsx-runtime-u17CrQMm.js";import{L as f}from"./Link-BgRVPD9O.js";import"./iframe-B1LqoTC5.js";import"./preload-helper-PPVm8Dsz.js";const s=({title:i="On this page",links:o,className:c=""})=>{const r="ntgds-in-page-navigation",p=[r,c].filter(Boolean).join(" ");return e.jsxs("nav",{className:p,children:[e.jsx("h2",{className:`${r}__title`,children:i}),e.jsx("ul",{className:`${r}__links`,children:o.map((l,h)=>e.jsx("li",{children:e.jsx(f,{href:l.href,children:l.label})},h))})]})};try{s.displayName="InPageNavigation",s.__docgenInfo={description:`InPageNavigation component for displaying page section links.
