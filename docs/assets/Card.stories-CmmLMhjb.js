import{j as e}from"./jsx-runtime-u17CrQMm.js";import{L as B}from"./Link-DsCUPYgB.js";import"./iframe-BUz-dUh1.js";import{T as t}from"./Tag-EoLSYcnD.js";import{B as i}from"./Button-Ct52YEEU.js";import{I as r}from"./Image-BcBNelRs.js";import{I as R}from"./Icon-D9ZymXa3.js";import"./preload-helper-PPVm8Dsz.js";const n=({image:j,header:I,icon:s,variant:o="default",title:_,description:d,footer:k,href:N,disabled:T=!1,className:S="",...L})=>{const a="ntgds-card",F=[a,o==="minicard"&&`${a}--minicard`,o==="static"&&`${a}--static`,T&&`${a}--disabled`,S].filter(Boolean).join(" "),D=e.jsxs("article",{className:F,...!N&&!T&&{tabIndex:0},...L,children:[j&&e.jsx("div",{className:`${a}__image`,children:j}),e.jsxs("div",{className:`${a}__content`,children:[I&&e.jsx("div",{className:`${a}__header`,children:I}),e.jsxs("div",{className:`${a}__body`,children:[s&&o==="static"?e.jsxs(e.Fragment,{children:[e.jsx("div",{className:`${a}__icon ${a}__icon--large`,children:s}),e.jsxs("div",{className:`${a}__title-and-body`,children:[e.jsx("div",{className:`${a}__title-container`,children:e.jsx("h3",{className:`${a}__title`,children:_})}),d&&e.jsx("p",{className:`${a}__description`,children:d})]})]}):s?e.jsxs("div",{className:`${a}__title-container ${o==="minicard"?`${a}__title-container--vertical`:""}`,children:[e.jsx("div",{className:`${a}__icon`,children:s}),e.jsx("h3",{className:`${a}__title`,children:_})]}):e.jsx("h3",{className:`${a}__title`,children:_}),!s||o!=="static"?d&&e.jsx("p",{className:`${a}__description`,children:d}):null]}),k&&e.jsx("div",{className:`${a}__footer`,children:k})]})]});return N&&!T?e.jsx(B,{href:N,className:"ntgds-card-link",children:D}):D};try{n.displayName="Card",n.__docgenInfo={description:`Card component for displaying content with optional image, header, footer, and clickable behavior.
...
When footer is provided, href should be omitted to avoid nested interactivity issues.`,displayName:"Card",props:{image:{defaultValue:null,description:"Image content (pass Image component as ReactNode for maximum flexibility)",name:"image",required:!1,type:{name:"ReactNode"}},header:{defaultValue:null,description:"Header content (typically Tag + date span with .ntgds-card__date class)",name:"header",required:!1,type:{name:"ReactNode"}},icon:{defaultValue:null,description:"Icon to display inline with title (optional, typically Icon component)",name:"icon",required:!1,type:{name:"ReactNode"}},variant:{defaultValue:{value:"default"},description:"Card variant: default (inline icon), minicard (vertical icon), or static (large left icon)",name:"variant",required:!1,type:{name:"enum",value:[{value:'"default"'},{value:'"minicard"'},{value:'"static"'}]}},title:{defaultValue:null,description:"Card title (required for semantic consistency, screen readers, and SEO)",name:"title",required:!0,type:{name:"string"}},description:{defaultValue:null,description:"Card description text",name:"description",required:!1,type:{name:"string"}},footer:{defaultValue:null,description:"Footer content (typically Button with tertiary variant and arrow icon)",name:"footer",required:!1,type:{name:"ReactNode"}},href:{defaultValue:null,description:"Link destination (makes entire card clickable, footer remains visible)",name:"href",required:!1,type:{name:"string"}},disabled:{defaultValue:{value:"false"},description:"Whether the card is disabled",name:"disabled",required:!1,type:{name:"boolean"}},className:{defaultValue:{value:""},description:"Additional CSS classes",name:"className",required:!1,type:{name:"string"}}}}}catch{}const q={title:"Components/Card",component:n,parameters:{layout:"padded"},tags:["autodocs"],argTypes:{image:{control:!1,description:"Image content (pass Image component as ReactNode)"},header:{control:!1,description:"Header content (typically Tag + date with .ntgds-card__date)"},title:{control:"text",description:"Card title (required for accessibility and SEO)"},description:{control:"text",description:"Card description text"},footer:{control:!1,description:"Footer content (typically Button with tertiary variant)"},href:{control:"text",description:"Link destination (makes card clickable, mutually exclusive with footer)"},disabled:{control:"boolean",description:"Whether the card is disabled"},className:{control:"text",description:"Additional CSS classes"}}},c={args:{title:"Card Title",description:"This is a simple card with just a title and description."}},l={args:{image:e.jsx(r,{src:"/demo-images/card-1.webp",alt:"Scenic landscape with gradient sky",width:"400",height:"200"}),title:"Card with Image",description:"This card includes a lightweight WEBP demo image."}},m={args:{header:e.jsxs(e.Fragment,{children:[e.jsx(t,{variant:"top-end-ac",children:"REGION"}),e.jsx("span",{className:"ntgds-card__date",children:"12 Dec 2024"})]}),title:"Card with Header",description:"This card has a header with a Tag and date."}},p={args:{icon:e.jsx(R,{name:"heart",size:"md",color:"primary"}),title:"Card with Icon",description:"Join in and honour the resilience of survivors and the lives lost."},parameters:{docs:{description:{story:"Card with an icon displayed inline with the title. The icon and title are aligned with an 8px gap in a flex container."}}}},h={args:{icon:e.jsx(R,{name:"compass",size:"md",color:"primary"}),variant:"minicard",title:"Card title"},parameters:{docs:{description:{story:"Minicard variant with icon positioned vertically above the title. Compact layout with 24px padding ideal for topic cards or navigation elements."}}}},g={args:{icon:e.jsx(R,{name:"phone",size:"lg",color:"primary"}),variant:"static",title:"Card title",description:"1800 000 000 or ext 12345"},parameters:{docs:{description:{story:"Static card variant with large icon (48px) on the left and title/description stacked on the right. Horizontal layout with 12px gap ideal for contact cards or info blocks."}}}},u={args:{title:"Card with Footer",description:"This card includes a footer with a tertiary button.",footer:e.jsx(i,{variant:"tertiary",iconRight:"arrow-right",padLeft:!1,children:"Read more"})}},v={name:"Full Card (Figma Design)",args:{image:e.jsx(r,{src:"/demo-images/card-1.webp",alt:"Northern Territory landscape",width:"400",height:"200"}),header:e.jsxs(e.Fragment,{children:[e.jsx(t,{variant:"top-end-ac",children:"TOP END"}),e.jsx("span",{className:"ntgds-card__date",children:"2 Dec 2025"})]}),title:"NT Government Announces New Initiative",description:"Comprehensive update on the latest program designed to support Territory communities and drive regional development.",footer:e.jsx(i,{variant:"tertiary",iconRight:"arrow-right",children:"Read more"})},parameters:{docs:{description:{story:"Complete card implementation matching Figma specifications with all elements: image, Tag header, date, title, description, and tertiary button footer."}}}},f={args:{image:e.jsx(r,{src:"/demo-images/card-2.webp",alt:"News article thumbnail",width:"400",height:"200"}),header:e.jsxs(e.Fragment,{children:[e.jsx(t,{variant:"default",children:"NEWS"}),e.jsx("span",{className:"ntgds-card__date",children:"1 Dec 2025"})]}),title:"Community Consultation Opens for Major Project",description:"Residents invited to provide feedback on proposed infrastructure improvements in the greater Darwin area.",footer:e.jsx(i,{variant:"tertiary",iconRight:"arrow-right",padLeft:!1,children:"Learn more"})}},w={args:{image:e.jsx(r,{src:"/demo-images/card-3.webp",alt:"Event venue",width:"400",height:"200"}),header:e.jsxs(e.Fragment,{children:[e.jsx(t,{variant:"darwin-ac",children:"DARWIN"}),e.jsx("span",{className:"ntgds-card__date",children:"15 Dec 2025"})]}),title:"Annual Territory Day Celebrations",description:"Join us for fireworks, live music, and family activities at Mindil Beach to celebrate Territory Day.",footer:e.jsx(i,{variant:"tertiary",iconRight:"arrow-right",padLeft:!1,children:"View details"})},parameters:{docs:{description:{story:"Event card using the Darwin accessible color variant (darwin-ac) for improved contrast and WCAG compliance."}}}},y={args:{image:e.jsx(r,{src:"/demo-images/card-4.webp",alt:"Article preview",width:"400",height:"200"}),header:e.jsxs(e.Fragment,{children:[e.jsx(t,{variant:"subtle",children:"ARTICLE"}),e.jsx("span",{className:"ntgds-card__date",children:"28 Nov 2025"})]}),title:"Understanding Territory Heritage Programs",description:"Explore how the NT Government is preserving and promoting indigenous heritage sites across the region.",href:"/articles/heritage-programs"},parameters:{docs:{description:{story:"Clickable card with href prop. The entire card becomes a link (footer is excluded). Hover to see border color change and the title color shift to the link hover token."}}}},x={name:"Footer Hover Sync",args:{image:e.jsx(r,{src:"/demo-images/card-1.webp",alt:"Sync hover demo",width:"400",height:"200"}),header:e.jsxs(e.Fragment,{children:[e.jsx(t,{variant:"default",children:"NEWS"}),e.jsx("span",{className:"ntgds-card__date",children:"3 Dec 2025"})]}),title:"Hover syncs title and footer label",description:"Hovering the card container updates the tertiary footer button label color to the link hover token, matching the RN hover spec.",footer:e.jsx(i,{variant:"tertiary",iconRight:"arrow-right",padLeft:!1,children:"Learn more"})},parameters:{docs:{description:{story:"Non-clickable card demonstrating container hover updating the footer tertiary button label color. This aligns footer behavior with title hover styling."}}}},b={args:{image:e.jsx(r,{src:"/demo-images/card-2.webp",alt:"Disabled card",width:"400",height:"200"}),title:"Disabled Card Example",description:"This card is disabled and non-interactive.",footer:e.jsx(i,{variant:"tertiary",iconRight:"arrow-right",children:"Read more"}),disabled:!0}},C={name:"Responsive Grid Layout",render:()=>e.jsxs("div",{style:{display:"grid",gridTemplateColumns:"repeat(auto-fill, minmax(300px, 1fr))",gap:"24px",maxWidth:"1200px"},children:[e.jsx(n,{image:e.jsx(r,{src:"/demo-images/card-1.webp",alt:"Card 1 landscape",width:"400",height:"200"}),header:e.jsxs(e.Fragment,{children:[e.jsx(t,{variant:"darwin-ac",children:"DARWIN"}),e.jsx("span",{className:"ntgds-card__date",children:"2 Dec 2025"})]}),title:"Grid Card One",description:"Demonstrating responsive grid layout with 4-6-12 column behavior.",footer:e.jsx(i,{variant:"tertiary",iconRight:"arrow-right",padLeft:!1,children:"Read more"})}),e.jsx(n,{image:e.jsx(r,{src:"/demo-images/card-2.webp",alt:"Card 2 urban",width:"400",height:"200"}),header:e.jsxs(e.Fragment,{children:[e.jsx(t,{variant:"top-end-ac",children:"TOP END"}),e.jsx("span",{className:"ntgds-card__date",children:"1 Dec 2025"})]}),title:"Grid Card Two",description:"Cards automatically adjust width at breakpoints: 33.33% (lg), 50% (md), 100% (mobile).",footer:e.jsx(i,{variant:"tertiary",iconRight:"arrow-right",padLeft:!1,children:"Learn more"})}),e.jsx(n,{image:e.jsx(r,{src:"/demo-images/card-3.webp",alt:"Card 3 nature",width:"400",height:"200"}),header:e.jsxs(e.Fragment,{children:[e.jsx(t,{variant:"barkly-ac",children:"BARKLY"}),e.jsx("span",{className:"ntgds-card__date",children:"30 Nov 2025"})]}),title:"Grid Card Three",description:"Image height also responds: 200px on desktop, 150px on mobile.",footer:e.jsx(i,{variant:"tertiary",iconRight:"arrow-right",padLeft:!1,children:"View details"})}),e.jsx(n,{image:e.jsx(r,{src:"/demo-images/card-4.webp",alt:"Card 4 ocean",width:"400",height:"200"}),header:e.jsxs(e.Fragment,{children:[e.jsx(t,{variant:"central-australia-ac",children:"CENTRAL"}),e.jsx("span",{className:"ntgds-card__date",children:"29 Nov 2025"})]}),title:"Grid Card Four",description:"Resize browser window to see responsive grid behavior in action.",footer:e.jsx(i,{variant:"tertiary",iconRight:"arrow-right",padLeft:!1,children:"Discover"})})]}),parameters:{docs:{description:{story:"Grid layout demonstration showing 4 cards with responsive behavior. Cards display as 4 columns on large screens (≥992px), 6 columns on medium screens (≥768px), and 12 columns on mobile (<768px). Image heights adjust from 200px (desktop) to 150px (mobile)."}}}};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`{
  ...
  args: {
    image: <Image src="/demo-images/card-1.webp" alt="Scenic landscape with gradient sky" width="400" height="200" />,
  ...
  args: {
    image: <Image src="/demo-images/card-1.webp" alt="Northern Territory landscape" width="400" height="200" />,
    header: <>\r
  ...
  args: {
    image: <Image src="/demo-images/card-2.webp" alt="News article thumbnail" width="400" height="200" />,
    header: <>\r
  ...
  args: {
    image: <Image src="/demo-images/card-3.webp" alt="Event venue" width="400" height="200" />,
    header: <>\r
  ...
  args: {
    image: <Image src="/demo-images/card-4.webp" alt="Article preview" width="400" height="200" />,
    header: <>\r
  ...
  args: {
    image: <Image src="/demo-images/card-1.webp" alt="Sync hover demo" width="400" height="200" />,
    header: <>\r
        <Tag variant="default">NEWS</Tag>\r
  ...
  args: {
    image: <Image src="/demo-images/card-2.webp" alt="Disabled card" width="400" height="200" />,
  ...
  render: () => <div style={{
    ...
    maxWidth: "1200px"
      ...
      <Card image={<Image src="/demo-images/card-1.webp" alt="Card 1 landscape" width="400" height="200" />} header={<>\r
            <Tag variant="darwin-ac">DARWIN</Tag>\r
            <span className="ntgds-card__date">2 Dec 2025</span>\r
      ...
      <Card image={<Image src="/demo-images/card-2.webp" alt="Card 2 urban" width="400" height="200" />} header={<>\r
            <Tag variant="top-end-ac">TOP END</Tag>\r
            <span className="ntgds-card__date">1 Dec 2025</span>\r
      ...
      <Card image={<Image src="/demo-images/card-3.webp" alt="Card 3 nature" width="400" height="200" />} header={<>\r
      ...
      <Card image={<Image src="/demo-images/card-4.webp" alt="Card 4 ocean" width="400" height="200" />} header={<>\r
...
}`,...C.parameters?.docs?.source}}};const z=["Default","WithImage","WithHeader","WithIcon","MiniCard","StaticCard","WithFooter","FullCardFigma","NewsCard","EventCard","ClickableCard","FooterHoverSync","DisabledCard","GridDemo"];export{y as ClickableCard,c as Default,b as DisabledCard,w as EventCard,x as FooterHoverSync,v as FullCardFigma,C as GridDemo,h as MiniCard,f as NewsCard,g as StaticCard,u as WithFooter,m as WithHeader,p as WithIcon,l as WithImage,z as __namedExportsOrder,q as default};
