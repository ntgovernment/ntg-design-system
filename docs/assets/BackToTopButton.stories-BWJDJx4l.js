import{j as e}from"./jsx-runtime-u17CrQMm.js";import{R as g}from"./iframe-CqofpB-E.js";import{I as b}from"./Icon-D9ZymXa3.js";import"./preload-helper-PPVm8Dsz.js";const t=g.forwardRef(({onClick:s,ariaLabel:i="Back to top",className:p="",...d},u)=>{const c="ntgds-back-to-top",m=l=>{l.preventDefault(),window.scrollTo({top:0,behavior:"smooth"}),s&&s(l)},h=[c,p].filter(Boolean).join(" ");return e.jsxs("button",{ref:u,className:h,onClick:m,"aria-label":i,type:"button",...d,children:[e.jsx("span",{className:`${c}__text`,children:"Back to top"}),e.jsx(b,{name:"arrow-up",size:"sm",color:"default",className:`${c}__icon`})]})});t.displayName="BackToTopButton";try{t.displayName="BackToTopButton",t.__docgenInfo={description:`BackToTopButton component for scrolling back to the top of a page.
